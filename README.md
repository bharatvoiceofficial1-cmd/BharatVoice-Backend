...
3. **Copy your Live Backend URL:**
   Live API URL: `https://api.bharatvoiceduai.website` (or Render default `https://bharatvoice-backend-qvj1.onrender.com`).
...
* **CORS Configured:** Accepts requests from your custom domain (`bharatvoiceduai.website`).
